...
document.querySelector("#createdBy").innerHTML += " Angel Villamil";
...
function buildToDos(toDos) {
  ...
  return toDos.map((objeto, index) => {
    return buildToDo(objeto, index);
  });
}
...
function addToDo() {
  ...
  let toDo = new ToDo(document.querySelector("#toDoInput").value);
